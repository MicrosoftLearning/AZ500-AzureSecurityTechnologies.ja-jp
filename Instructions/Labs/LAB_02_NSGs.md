...
lab:
  ...
  description: このタスクでは、ネットワークおよびアプリケーションのセキュリティ グループで使用する仮想ネットワークを作成します。
  duration: 20 minutes
  level: 300
  islab: true
---
...
2. **[仮想マシン]** ブレードで **[+ 作成]** をクリックし、ドロップダウン リストで **[仮想マシン]** をクリックします。
...
6. **[仮想マシンの作成]** ブレードの **[ネットワーク]** タブで、前に作成したネットワーク **myVirtualNetwork** と **default (10.0.0.0/24)** サブネットを選びます。
...
1. Azure portal で **[仮想マシン]** ブレードに戻り、**[+ 作成]** をクリックして、ドロップダウンリストで **[仮想マシン]** をクリックします。
...
5. **[仮想マシンの作成]** ブレードの **[ネットワーク]** タブで、前に作成したネットワーク **myVirtualNetwork** と **default (10.0.0.0/24)** サブネットを選びます。
...
7. [+ **アプリケーション セキュリティ グループの追加]** をクリックし、**アプリケーション セキュリティ グループ]** 一覧で **[myAsgMgmtServers]** を選択し、**[追加]** をクリックします。
...
1. Azure portal の右上にある最初のアイコンをクリックして、Cloud Shell を開きます。 メッセージが表示されたら、**[PowerShell]** と **[ストレージ アカウントは必要ありません]** を選び、自分のサブスクリプションの名前を選んで、**[適用]** を選びます。
