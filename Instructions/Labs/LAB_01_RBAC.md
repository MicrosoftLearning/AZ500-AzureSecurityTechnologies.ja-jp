...
2. メッセージが表示されたら、**[ストレージ アカウントは必要ありません]** を選択し、サブスクリプションの名前を選択して、**[適用]** を選択します。 これは、Cloud Shell を "初めて起動する場合にのみ" 必要です。**

3. Cloud Shell 画面の左上隅にあるドロップダウン メニューから **[PowerShell] が選択されていることを確認します**。 (注:新しい Cloud Shell では、**[-->Bash に切り替える]** と表示されます)
...
1. [Cloud Shell] ペインの左上隅にあるドロップダウン メニューで **[Bash]** (または **[Bash に切り替える]**) を選択し、メッセージが表示されたら、**[確認]** クリックします。 
...
9. 検索結果の一覧で、Dylan Williams のユーザー アカウントを選択し、**[Dylan Williams の割り当て - AZ500Lab01]** ブレードで、新しく作成された割り当てを表示します。
   ...
   > 注 - RBAC の割り当てを確認するときは、常に **[アクティブ]** タブと **[適格]** タブの両方を確認してください。
