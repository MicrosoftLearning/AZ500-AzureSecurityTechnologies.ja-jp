...
10. 「**Review + create**」をクリックし、「**作成**」をクリックします。
...
2. **[ユーザー \| すべてのユーザー (プレビュー)]** ブレードで、 **[+ 新しいユーザー]** をクリックします。 
...
4. **[ユーザー \| すべてのユーザー (プレビュー)]** ブレードに戻り、 **[+ 新しいユーザー]** をクリックします。 
...
6. **[ユーザー \| すべてのユーザー (プレビュー)]** ブレードに戻り、 **[+ 新しいユーザー]** をクリックします。 
...
6. 「**ユーザー**」タブに切り替えて、「**aaduser1**」エントリをクリックし、「**有効**」リンクをクリックします。プロンプトが表示されたら、「**Multi-Factor Auth を有効にする**」をクリックします。
...
4. 「**アカウントを安全に保つ**」ページで、「**別の方法を設定しする**」リンクを選択し、「**どの方法を使用しますか？** 」ドロップダウンリストで「**電話**」を選択し、「**確認**」を選択します。
