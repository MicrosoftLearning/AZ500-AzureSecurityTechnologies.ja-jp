...
5. RDP ファイルをダウンロードし、これを使用して、リモート デスクトップ経由で**az500-10-vm1** Azure VM に接続します。 認証を求められたら、次の資格情報を入力します。
...
- タスク 1:Visutal Studio 2022 をインストールする
...
7. **[Visual Studio 2022]** ボックスの **[Community]** で **[無料ダウンロード]** を選択します。
